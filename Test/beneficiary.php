                ...
                <form class="search_form" action="" method="post">
                    ...
                    <div class="flex-item-search-by">
                        <select name="by" id="by">
                            ...
                            <option value="acno">A/c No</option>
                        </select>
                    </div>
                </form>
                        ...
                        <div class="flex-item-1">
                            <div class="dropdown">
                              ...
                              <div id="dropdown<?php echo $i ?>" class="dropdown-content">
                                ...
                                <a href="./send_funds.php?cust_id=<?php echo $row1["cust_id"] ?>">Send Money</a>
                                <a href="./delete_beneficiary.php?cust_id=<?php echo $row1["cust_id"] ?>"
                                     onclick="return confirm('Are you sure?')">Delete Beneficiary</a>
                              </div>
                            </div>
                        </div>
                    </div>
