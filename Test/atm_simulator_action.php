<?php
    ...
    $sql_acno = "SELECT * FROM customer WHERE cust_id=".$id." AND account_no='".$acno."'";
    $result_acno = $conn->query($sql_acno);

    if (($result_acno->num_rows) > 0) {
...
<body>
    <div class="flex-container">
        <div class="flex-item">
            ...
            <?php
            if ($err_no == 2) { ?>
                <p id="info"><?php echo "Wrong Account Num Entered !\n"; ?></p>
            <?php } ?>
        </div>
